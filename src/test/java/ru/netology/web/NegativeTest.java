...
public class NegativeTest {
    ...
    @Test
    public void shouldFailedByIncorrectName() {
    ...
    @Test
    public void shouldFailedByEmptyName() {
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79123456789");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.cssSelector("button.button")).click();
    ...
    @Test
    public void shouldFailedByIncorrectPhone() {
    ...
    @Test
    public void shouldFailedByEmptyPhone() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Иванов Иван-Иванович");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.cssSelector("button.button")).click();
        assertEquals("Поле обязательно для заполнения",
    ...
    @Test
    public void shouldFailedByUncheckedCheckbox() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Иванов Иван-Иванович");
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79123456789");
        driver.findElement(By.cssSelector("button.button")).click();
